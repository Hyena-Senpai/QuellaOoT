...
char gSlotAgeReqs[] = {
    ...
    AGE_REQ_NONE, // SLOT_BOW
    AGE_REQ_NONE, // SLOT_ARROW_FIRE
    AGE_REQ_NONE,  // SLOT_DINS_FIRE
    AGE_REQ_NONE, // SLOT_SLINGSHOT
    AGE_REQ_NONE,  // SLOT_OCARINA
    AGE_REQ_NONE,  // SLOT_BOMBCHU
    AGE_REQ_NONE, // SLOT_HOOKSHOT
    AGE_REQ_NONE, // SLOT_ARROW_ICE
    AGE_REQ_NONE,  // SLOT_FARORES_WIND
    AGE_REQ_NONE, // SLOT_BOOMERANG
    AGE_REQ_NONE,  // SLOT_LENS_OF_TRUTH
    AGE_REQ_NONE, // SLOT_MAGIC_BEAN
    AGE_REQ_NONE, // SLOT_HAMMER
    AGE_REQ_NONE, // SLOT_ARROW_LIGHT
    ...
    AGE_REQ_NONE, // SLOT_TRADE_ADULT
    AGE_REQ_NONE, // SLOT_TRADE_CHILD
};
...
char gEquipAgeReqs[4][4] = {
    {
        ...
        AGE_REQ_NONE, // EQUIP_TYPE_SWORD EQUIP_VALUE_SWORD_MASTER
...
char gItemAgeReqs[] = {
    ...
    AGE_REQ_NONE, // ITEM_BOW
    AGE_REQ_NONE, // ITEM_ARROW_FIRE
    AGE_REQ_NONE,  // ITEM_DINS_FIRE
    AGE_REQ_NONE, // ITEM_SLINGSHOT
    AGE_REQ_NONE,  // ITEM_OCARINA_FAIRY
    AGE_REQ_NONE,  // ITEM_OCARINA_OF_TIME
    AGE_REQ_NONE,  // ITEM_BOMBCHU
    AGE_REQ_NONE, // ITEM_HOOKSHOT
    AGE_REQ_NONE, // ITEM_LONGSHOT
    AGE_REQ_NONE, // ITEM_ARROW_ICE
    AGE_REQ_NONE,  // ITEM_FARORES_WIND
    AGE_REQ_NONE, // ITEM_BOOMERANG
    AGE_REQ_NONE,  // ITEM_LENS_OF_TRUTH
    AGE_REQ_NONE, // ITEM_MAGIC_BEAN
    AGE_REQ_NONE, // ITEM_HAMMER
    AGE_REQ_NONE, // ITEM_ARROW_LIGHT
    ...
    AGE_REQ_NONE, // ITEM_WEIRD_EGG
    AGE_REQ_NONE, // ITEM_CHICKEN
    AGE_REQ_NONE, // ITEM_ZELDAS_LETTER
    AGE_REQ_NONE, // ITEM_MASK_KEATON
    AGE_REQ_NONE, // ITEM_MASK_SKULL
    AGE_REQ_NONE, // ITEM_MASK_SPOOKY
    AGE_REQ_NONE, // ITEM_MASK_BUNNY_HOOD
    AGE_REQ_NONE, // ITEM_MASK_GORON
    AGE_REQ_NONE, // ITEM_MASK_ZORA
    AGE_REQ_NONE, // ITEM_MASK_GERUDO
    AGE_REQ_NONE, // ITEM_MASK_TRUTH
    AGE_REQ_NONE, // ITEM_SOLD_OUT
    AGE_REQ_NONE, // ITEM_POCKET_EGG
    AGE_REQ_NONE, // ITEM_POCKET_CUCCO
    AGE_REQ_NONE, // ITEM_COJIRO
    AGE_REQ_NONE, // ITEM_ODD_MUSHROOM
    AGE_REQ_NONE, // ITEM_ODD_POTION
    AGE_REQ_NONE, // ITEM_POACHERS_SAW
    AGE_REQ_NONE, // ITEM_BROKEN_GORONS_SWORD
    AGE_REQ_NONE, // ITEM_PRESCRIPTION
    AGE_REQ_NONE, // ITEM_EYEBALL_FROG
    AGE_REQ_NONE, // ITEM_EYE_DROPS
    AGE_REQ_NONE, // ITEM_CLAIM_CHECK
    AGE_REQ_NONE, // ITEM_BOW_FIRE
    AGE_REQ_NONE, // ITEM_BOW_ICE
    AGE_REQ_NONE, // ITEM_BOW_LIGHT
    AGE_REQ_NONE, // ITEM_SWORD_KOKIRI
    AGE_REQ_NONE, // ITEM_SWORD_MASTER
    ...
    AGE_REQ_NONE, // ITEM_BOOTS_IRON
    AGE_REQ_NONE, // ITEM_BOOTS_HOVER
    AGE_REQ_NONE, // ITEM_BULLET_BAG_30
    AGE_REQ_NONE, // ITEM_BULLET_BAG_40
    AGE_REQ_NONE, // ITEM_BULLET_BAG_50
    AGE_REQ_NONE, // ITEM_QUIVER_30
    AGE_REQ_NONE, // ITEM_QUIVER_40
    AGE_REQ_NONE, // ITEM_QUIVER_50
    AGE_REQ_NONE,  // ITEM_BOMB_BAG_20
    AGE_REQ_NONE,  // ITEM_BOMB_BAG_30
    AGE_REQ_NONE,  // ITEM_BOMB_BAG_40
    AGE_REQ_NONE, // ITEM_STRENGTH_GORONS_BRACELET
    AGE_REQ_NONE, // ITEM_STRENGTH_SILVER_GAUNTLETS
    AGE_REQ_NONE, // ITEM_STRENGTH_GOLD_GAUNTLETS
